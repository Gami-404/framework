...
class BladeCompiler extends Compiler implements CompilerInterface
{
    ...
    public function compile($path = null)
    {
        ...
        if (!is_null($this->cachePath)) {
            ...
            if ($this->app['config']['view.removeWhitespace'] == true) {
                $contents = $this->removeWhitespaceContent($contents);
            }
    ...
    /**
     * Remove whitespace from cached views
     * ignore script , pre and textarea tags
     * @param $contents
     * @return mixed
     */
    protected function removeWhitespaceContent($contents)
    {
        $replace = [
